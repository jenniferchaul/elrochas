...
<main id="primary" class="site-main about-page">
  ...
  <!-- 2) Portrait (net avec srcset auto) -->
      ...
      <figure class="portrait-figure">
        ...
        if ( has_post_thumbnail() ) {
          echo get_the_post_thumbnail(
            get_the_ID(),
            'large', // taille WP qui génère srcset automatiquement
            [
              'class'   => 'portrait-img',
              'alt'     => 'Portrait d’Elisabeth Rochas',
              'sizes'   => '(min-width: 900px) 260px, 210px', // 260px desktop / 210px mobile
              'loading' => 'lazy',
              'decoding'=> 'async',
            ]
          );
        } else {
          // Fallback (fournis une image ≥ 520×520 pour rester nette sur retina)
  ...
  <!-- 3) Mon histoire (version développée) -->
  ...
  <!-- 4) Repères de parcours (développé, pas juste des bullets) -->
  ...
  <!-- 5) Formations & certifications (clarifiées, sans “catalogue d’outils”) -->
  ...
  <!-- 6) Zone éditable (si tu veux coller son texte intégral en bas) -->
